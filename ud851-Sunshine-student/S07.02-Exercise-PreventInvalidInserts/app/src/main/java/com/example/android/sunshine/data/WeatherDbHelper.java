...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    //Completed  TODO (2) Increment the database version after altering the behavior of the table
    /*
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                //Completed: TODO (1) Append NOT NULL to each column's type declaration except for the _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        //Completed TODO (3) Within onUpgrade, drop the weather table if it exists
        //This SQL command allows you to drop one table at a time.
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME);
        //Completed TODO (4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
        //Comments by @steven_ackerman:
